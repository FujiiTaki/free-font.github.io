...
export default {
  ...
  beforeSaveHTML: async (html, output, filename, isWatch) => {
    ...
    // Generate last-update.js file with current date
    const now = new Date();
    const lastUpdateContent = `// Auto-generated by build process\nwindow.LAST_UPDATE_DATE = new Date('${now.toISOString()}');\n`;
    writeFileSync("./docs/js/last-update.js", lastUpdateContent);
